        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="/dashboard/gurudashboard" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Data Guru</a>
                                        ...
                                        <div class="flex flex-wrap">             
                                           <div class=" text-center" style="max-width: 300px;">
                                              ...
                                              <div class="card-body">
                                                 ...
                                                 <a href="/guru/hapus/{{ $s->id}}" class="btn btn-primary">Hapus</a>
                                              </div>
                                            </div>
                                        </div>
                                     </div>
