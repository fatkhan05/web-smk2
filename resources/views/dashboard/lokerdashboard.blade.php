...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        <h6 class="mb-0">Fatkhan Akbar</h6>
                        <span>Admin</span>
                    </div>
                </div>
                <div class="navbar-nav w-100">
                    <a href="/dashboard" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <a href="/dashboard/siswadashboard" class="nav-item nav-link "><i class="fa fa-th me-2"></i>Data Siswa</a>
                    <a href="/dashboard/gurudashboard" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Data Guru</a>
                    <a href="/dashboard/lokerdashboard" class="nav-item nav-link active"><i class="fa fa-chart-bar me-2"></i>Info Loker</a>
        ...
        <div class="content">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex">Fatkhan Akbar</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
            ...
            <a href="/loker/tambah" class="btn btn-primary mb-5">Tambah Loker</a>
                                  ...
                                  <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                      <div class="card-body">
                                        ...
                                        <a href="/loker/hapus/{{ $s->id}}" class="btn btn-primary">Hapus</a>
                                      </div>
                                    </div>              
                                  </div>            
                                </div>
